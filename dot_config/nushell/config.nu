...
alias c = claude
alias commit = claude -p "review the staged and unstaged git changes and create a commit with a clear conventional-commit message" --model claude-haiku-4-5-20251001 --allowedTools "Bash(git add:*)" "Bash(git commit:*)" "Bash(git status:*)" "Bash(git diff:*)" "Bash(git log:*)"
alias o = opencode
alias y = yazi
alias h = herdr
