# Generated by Powerlevel10k configuration wizard on 2024-06-13 at 20:43 +07.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 26839.
# Wizard options: nerdfont-v3 + powerline, large icons, unicode, lean, 1 line, sparse,
# many icons, fluent, instant_prompt=auto-quiet.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=99
  # Custom icon.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%99F'   # green foreground
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_FOREGROUND=7
